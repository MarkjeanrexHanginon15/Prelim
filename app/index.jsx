      ...
      <ScrollView contentContainerStyle={{height:'100%'}}>
        <View className="w-full justify-center, items-center min-h-screenh-[85vh] px-4">
              ...
              <View className="relative mt-5">
                  ...
                  The movie app allows users to discover, stream, and track their favorite films with personalized recommendations and reviews.
                  </Text>
              </View>
            <Text className="text-sm, font-j_bold text-gray-100 mt-7 text-center"> Join us, Book Now!
            </Text>
            <CustomButton
